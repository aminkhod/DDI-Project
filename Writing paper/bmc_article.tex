...
2) The categorical-cross entropy loss function was considered as objective function for the neural network which is generally used to train a classification network \cite{ghosal1997your, toda2012research, seen20121}.

3) ADAM optimization \cite{kingma2014adam} was used to manipulate the neural network weights in order to find promising optimal (minimum) state of the loss function.
