...
\usepackage[linktocpage=true,colorlinks,pagebackref=false,linkcolor=black,citecolor=black]{hyperref}
...
\usepackage{array}
\usepackage{tabu}
% فراخوانی بسته زی‌پرشین و تعریف قلم فارسی و انگلیسی\usepackage{algorithm}
...
\defpersianfont\XBSols[Scale=2]{XB Sols}
%%%%%%%%%%%%%%%%%%%%%%%%%%
